# 🎨 disAbility Service Icons

A collection of accessible icons, artwork, and visual assets created for the **Trinity disAbility Service** and related projects at **Trinity College Dublin**.

Each folder contains PNG and/or SVG files related to that theme.  
File names are descriptive to make searching and accessibility tagging easier.

---

## 💡 How to Use These Icons

You can copy and paste these icons directly into your projects or presentations.

### ➤ Using in PowerPoint or Word

1. Open your PowerPoint or Word document.
